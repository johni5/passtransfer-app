...
import com.del.pst.camera.CameraSource;
import com.del.pst.camera.CameraSourcePreview;
import com.del.pst.camera.GraphicOverlay;
import com.del.pst.databinding.ActivityConnectBinding;
...
public class ConnectActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener {

    private static final String TAG = "connect-activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_activity_connect));
        ...
        binding.connectionInfo.setText(getIntent().getStringExtra("HOST"));
    ...
    public void onBarcodeDetected(Barcode barcode) {
        ...
        new ReadBarcodeTask().execute(barcode);

    }

    @SuppressLint("StaticFieldLeak")
    private class ReadBarcodeTask extends AsyncTask<Barcode, Void, String> {
        ...
        @Override
        protected String doInBackground(Barcode... s) {
